...
| Local API Server | Available | Run `cd apps/api && ../../.venv/bin/python -m uvicorn app.main:app --host 127.0.0.1 --port 8000 --reload`; `/api/v1/health` and `/api/v1/auth/google` are verified. |
